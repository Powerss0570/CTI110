...
while contin == 'y':
    ...
    if Tip == 0.16 or Tip == 0.18 or Tip == 0.20:
        ...
        print('The calculated tip is $ %.2f' % Tip_Amount)

        print('The calculated tax is $ %.2f' % Tax_Amount)

        print('The calculated Total is $ %.2f' % Total_cost)
        contin = input("Would you like to run program again and enter another tip y/n?")
        ...
        print('The calculated tip is $ %.2f' % Tip_Amount2)
